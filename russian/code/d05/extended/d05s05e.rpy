...
translate russian d05s05e_c6b28873:
    ...
    mct "Эта девушка в разгромленной квартире..."

# game/code/d05/extended/d05s05e.rpy:8
translate russian d05s05e_2f99c654:

    # mct "Where do I remember her from?"
    mct "Откуда я ее помню?"

# game/code/d05/extended/d05s05e.rpy:15
translate russian d05s05e_9707a9f3:

    # mct "Oh! Right! I spoke to her in the park on Monday night."
    mct "О! Верно! Я разговаривал с ней в парке в понедельник вечером."

# game/code/d05/extended/d05s05e.rpy:20
translate russian d05s05e_7f5e01b5:

    # mct "She didn't even knew what is Fetish Locator back then."
    mct "Тогда она даже не знала, что такое Фетиш Локатор."

# game/code/d05/extended/d05s05e.rpy:23
translate russian d05s05e_ce548d15:

    # mct "Oh! Right! That is the girl from the party!"
    mct "О! Верно! Это та самая девушка с вечеринки!"

# game/code/d05/extended/d05s05e.rpy:29
translate russian d05s05e_7c58c44d:

    # mct "And she was on the party!"
    mct "И она была на вечеринке!"

# game/code/d05/extended/d05s05e.rpy:34
translate russian d05s05e_524a93b7:

    # mct "She was taking a photo of her pussy."
    mct "Она фотографировала свою киску."

# game/code/d05/extended/d05s05e.rpy:39
translate russian d05s05e_fed4898b:

    # mct "In fact, I ate her pussy out on the balcony later that night!"
    mct "И я даже вылизал ей киску на балконе позже той ночью!"

# game/code/d05/extended/d05s05e.rpy:45
translate russian d05s05e_ef530a55:

    # mct "I still don't know her name..."
    mct "Но я до сих пор не знаю ее имени..."

# game/code/d05/extended/d05s05e.rpy:47
translate russian d05s05e_574b68a0:

    # mct "But I've got her username now! Maybe I should reach out to URLittlePony."
    mct "Но теперь я знаю ее имя пользователя! Может быть, мне стоит связаться с ТвояМаленькаяПони."

# game/code/d05/extended/d05s05e.rpy:49
translate russian d05s05e_e46ad955:

    # mct "Oh. For some reason it will cost me 5 points to message her in the FL app."
    mct "Ох. По какой-то причине отправка сообщения стоит 5 очков в приложении ФЛ."

# game/code/d05/extended/d05s05e.rpy:52
translate russian d05s05e_eb0dcf0f:

    # mct "5 points just to send her a message?"
    mct "5 очков только для того, чтобы отправить ей сообщение?"

# game/code/d05/extended/d05s05e.rpy:53
translate russian d05s05e_46543154:

    # mct "Do I really want to contact this girl? She's hot, but seems a little... unusual."
    mct "Действительно ли я хочу связаться с этой девушкой? Она горячая штучка, но, кажется, немного... необычная."

# game/code/d05/extended/d05s05e.rpy:54
translate russian d05s05e_9bec7a24:

    # mct "And that username - your little pony. Do I even want to know what that means?"
    mct "И это имя пользователя - Твоя маленькая пони. Хочу ли я вообще знать, что это значит?"

# game/code/d05/extended/d05s05e.rpy:59
translate russian d05s05e_47b37da6:

    # mc "Alright - what do I say? I guess the first thing is..."
    mc "Ладно, что я ей скажу? Думаю, первое, что нужно сделать..."

# game/code/d05/extended/d05s05e.rpy:62
translate russian d05s05e_759ce6da:

    # mct "Nah... I would rather keep 5 points!"
    mct "Нет... Я бы предпочел оставить себе 5 очков!"

# game/code/d05/extended/d05s05e.rpy:64
translate russian d05s05e_abeca518:

    # mcfl "{i}Hey URLittlePony, it's [mclogin]. We should talk.{/i}"
    mcfl "{i}Привет, ТвояМаленькаяПони, это [mclogin]. Нам надо поговорить.{/i}"

# game/code/d05/extended/d05s05e.rpy:66
translate russian d05s05e_b446c172:

    # jffl "{i}You took that photo earlier today. What do you want with me?{/i}"
    jffl "{i}Ты сделал эту фотографию сегодня утром. Что тебе от меня нужно?{/i}"

# game/code/d05/extended/d05s05e.rpy:68
translate russian d05s05e_25ce065a:

    # mcfl "Good question."
    mcfl "Хороший вопрос."

# game/code/d05/extended/d05s05e.rpy:69
translate russian d05s05e_c12bd5a6:

    # mct "She's probably being blackmailed like I am, but I don't think it is a good idea to ask this through the app..."
    mct "Ее, вероятно, шантажируют, как и меня, но не думаю, что это хорошая идея, спрашивать об этом через приложение..."

# game/code/d05/extended/d05s05e.rpy:72
translate russian d05s05e_d32da9d1:

    # mcfl "{i}We met the other day. I even ate you out at the Party on Wednesday.{/i}"
    mcfl "{i}Мы познакомились на днях. Я даже вылизал тебе на вечеринке в среду.{/i}"

# game/code/d05/extended/d05s05e.rpy:74
translate russian d05s05e_7f98710c:

    # mcfl "{i}We met the other day in the Park, and then again at the Party when you were taking that pic up your skirt.{/i}"
    mcfl "{i}Мы встретились на днях в парке, а потом еще раз на вечеринке, когда ты снимала эту фотографию под юбкой.{/i}"

# game/code/d05/extended/d05s05e.rpy:76
translate russian d05s05e_84a584c0:

    # "?"
    "?"

# game/code/d05/extended/d05s05e.rpy:77
translate russian d05s05e_638c98ce:

    # jffl "Oh, it's you. I'm not sure if I should be relieved or scared."
    jffl "А, это ты. Я даже не знаю как на это реагировать. Пугаться или успокоится."

# game/code/d05/extended/d05s05e.rpy:78
translate russian d05s05e_ccb3278c:

    # mcfl "{i}Why would you be scared of me?{/i}"
    mcfl "{i}Почему ты боишься меня?{/i}"

# game/code/d05/extended/d05s05e.rpy:79
translate russian d05s05e_ccc5df52:

    # jffl "{i}Are you planning on blackmailing me with that photo or what?{/i}"
    jffl "{i}Ты собираешься шантажировать меня этой фотографией или как?{/i}"

# game/code/d05/extended/d05s05e.rpy:81
translate russian d05s05e_1469dcef:

    # mct "Fuck. Now she thinks that I'm blackmailing her too."
    mct "Твою мать. Теперь она думает, что я собираюсь ее шантажировать."

# game/code/d05/extended/d05s05e.rpy:83
translate russian d05s05e_f288e89e:

    # mcfl "{i}No. Definitely NOT. Actually, I wanted to apologize for that pic. I just needed the points.{/i}"
    mcfl "{i}Нет. Определенно НЕТ. Вообще-то, я хотел извиниться за тот случай в парке. Мне просто нужны были очки.{/i}"

# game/code/d05/extended/d05s05e.rpy:84
translate russian d05s05e_d900f650:

    # jffl "{i}I can understand that. Is there another party coming up?{/i}"
    jffl "{i}Понимаю. Скоро будет еще одна вечеринка?{/i}"

# game/code/d05/extended/d05s05e.rpy:85
translate russian d05s05e_3d361581:

    # mcfl "{i}Not that I know of. Maybe.{/i}"
    mcfl "{i}Насколько я знаю, нет. Может быть.{/i}"

# game/code/d05/extended/d05s05e.rpy:86
translate russian d05s05e_2a0ec449:

    # jffl "{i}You need more points?{/i}"
    jffl "{i}Тебе нужно больше очков?{/i}"

# game/code/d05/extended/d05s05e.rpy:87
translate russian d05s05e_40d60841:

    # mcfl "{i}Always!{/i}"
    mcfl "{i}Конечно!{/i}"

# game/code/d05/extended/d05s05e.rpy:88
translate russian d05s05e_8ec78ec9:

    # jffl "{i}Are you a good person? Can I trust you?{/i}"
    jffl "{i}Ты хороший человек? Могу ли я тебе доверять?{/i}"

# game/code/d05/extended/d05s05e.rpy:90
translate russian d05s05e_e3cc21eb:

    # mct "Probably not, but I'm not going to say that."
    mct "Возможно, что нет, но я не собираюсь этого говорить."

# game/code/d05/extended/d05s05e.rpy:92
translate russian d05s05e_f6abb886:

    # mcfl "{i}Sure. What do you have in mind?{/i}"
    mcfl "{i}Конечно. Что ты имеешь в виду?{/i}"

# game/code/d05/extended/d05s05e.rpy:93
translate russian d05s05e_e724de8d:

    # jffl "{i}I can show you how I usually get my points. Meet me tomorrow.{/i}"
    jffl "{i}Я могу показать тебе, как я обычно получаю свои очки. Встретимся завтра.{/i}"

# game/code/d05/extended/d05s05e.rpy:94
translate russian d05s05e_9690e6b4:

    # mcfl "{i}I'm kinda busy tomorrow.{/i}"
    mcfl "{i}Завтра я буду занят.{/i}"

# game/code/d05/extended/d05s05e.rpy:95
translate russian d05s05e_e1fff1a5:

    # jffl "{i}Message me when you aren't busy. We can meet by the benches in the Park.{/i}"
    jffl "{i}Напиши мне, когда будешь свободен. Мы можем встретиться на скамейках в парке.{/i}"

# game/code/d05/extended/d05s05e.rpy:96
translate russian d05s05e_0c720c99:

    # mcfl "{i}Sounds good. See you tomorrow!{/i}"
    mcfl "{i}Договорились. Увидимся завтра!{/i}"

# game/code/d05/extended/d05s05e.rpy:97
translate russian d05s05e_c4f06cb7:
...
translate russian strings:
    ...
    new "Связаться с ТвояМаленькаяПони"
