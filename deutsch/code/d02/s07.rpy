...
translate deutsch d02s07_1b4a430c:
    ...
    "Auf dem Weg nach draußen bemerkt er ein bekanntes Gesicht."

# game/d02/s07.rpy:104
translate deutsch d02s07_aa5d1abb:

    # mct "So, that's where Pete is!"
    mct "So, da steckt Pete also!"

# game/d02/s07.rpy:111
translate deutsch d02s07_dd58f4f5:

    # mc "Is it your breakfast?"
    mc "Ist das dein Frühstück?"

# game/d02/s07.rpy:114
translate deutsch d02s07_7859b2e5:

    # pb "I'm not so sure! I still haven't slept since yesterday... {w} It feels more like a late dinner!"
    pb "Da bin ich mir nicht so sicher! Ich habe seit gestern immer noch nicht geschlafen...{w} Fühlt sich mehr wie ein spätes Abendessen an!"

# game/d02/s07.rpy:115
translate deutsch d02s07_d8f340ff:

    # mc "Wow! That sounds like a hardcore party!?"
    mc "Wow! Das klingt nach einer heftigen Party!?"

# game/d02/s07.rpy:117
translate deutsch d02s07_fc986637:

    # pb "Yes! We went wild with celebration!"
    pb "Ja! Wir haben wie wild gefeiert!"
...
translate deutsch d02s07_485984f6:

    # mc "Well I earned some with the blitz challenge last night. But not many."
    mc "Naja, ich hab ein paar durch die Blitz Challenge verdient, aber nicht viele."

# game/d02/s07.rpy:144
translate deutsch d02s07_5aa55f0d:

    # mc "Wow! That’s a lot of points!"
    mc "Wow! Das sind eine Menge Punkte!"
...
translate deutsch d02s07_b806c105:
    ...
    pb "Auch wenn ich etwas zu spät dran war mit dem hochladen. Stell dir mal vor wie viel Punkte ich bekommen hätte, wenn ich in den 69 Sekunden gekommen wäre?"
...
translate deutsch d02s07_ef4e5b67:
    ...
    mc "Nicht wirklich. Ich war erfolglos..."

# game/d02/s07.rpy:161
translate deutsch d02s07_a9e13c97:

    # pb "Oh, that’s sad to hear! You need to hurry up! The party is tomorrow night!"
    pb "Oh, das ist schade! Du musst dich echt beeilen! Die Party ist morgen Abend!"

# game/d02/s07.rpy:162
translate deutsch d02s07_987394fa:

    # pb "There was an additional challenge last night. I got a lot of points from it!"
    pb "Es gab gestern Nacht eine zusätzliche Challenge. Da habe ich eine Menge Punkte verdient."
...
translate deutsch d02s07_803742a9:
    ...
    mc "Okay, ich werde versuchen mir was einfallen zu lassen!"

# game/d02/s07.rpy:169
translate deutsch d02s07_17fdb1f4:

    # mc "I’m gonna get going! See you!"
    mc "Ich mach mich besser auf den Weg! Wir sehen uns!"
...
translate deutsch d02s07_57f63532:

    # mct "I hope that I actually don't have to do anything with it!"
    mct "Ich hoffe eigentlich, dass ich damit gar nichts machen muss!"
...
translate deutsch d01s07_pete_about_girls_fcc1b776:
    ...
    pb "Hmmm, wo war ich stehen geblieben?"

# game/d02/s07.rpy:345
translate deutsch d01s07_pete_about_girls_16af2776:
...
translate deutsch d01s07_pete_about_girls_2_0741f128:
    ...
    pb "Genau auf ihr schönes blondes Haar! Kannst du das glauben?! Das war episch!"

# game/d02/s07.rpy:366
translate deutsch d01s07_pete_about_girls_2_5b5eb208:

    # pb "Got 25 points for that!"
    pb "Dafür habe ich 25 Punkte bekommen!"
...
translate deutsch strings:
    ...
    new "Hör auf deine [game.stacytitle] zu beobachten"

    # game/d02/s07.rpy:235
    old "Continue watching [game.stacytitle]"
    new "Beobachte deine [game.stacytitle] weiter"
...
translate deutsch d02s07_6e272b01:

    # pb "[mcname]! Hey!"
    pb "[mcname]! Hey!"

# game/code/d02/s07.rpy:113
translate deutsch d02s07_02b31895:

    # pb "Hmmm."
    pb "Hmmm."

# game/code/d02/s07.rpy:172
translate deutsch d02s07_7a11f59f:
...
translate deutsch replay_d02s07_63f812be:
...
translate deutsch replay_d02s07_4355860f:
...
translate deutsch replay_d02s07_cf1cd28e:
...
translate deutsch replay_d02s07_a18006d4:
...
translate deutsch replay_d02s07_a7b96636:
...
translate deutsch replay_d02s07_22fa5f40:
...
translate deutsch replay_d02s07_04cfb5d9:
...
translate deutsch replay_d02s07_b0a5fdcf:

    # sy "Mmmh"
    sy "Mmmh"

# game/code/d02/s07.rpy:263
translate deutsch replay_d02s07_21301221:
...
translate deutsch replay_d02s07_ae0e3462:
...
translate deutsch replay_d02s07_5c25b3ee:
