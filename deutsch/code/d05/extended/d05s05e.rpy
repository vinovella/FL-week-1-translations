...
translate deutsch d05s05e_2f99c654:
    ...
    mct "Von woher kenne ich sie nur?"
...
translate deutsch d05s05e_ce548d15:
    ...
    mct "Oh! Richtig! Sie ist das Mädchen von der Party!"

# game/code/d05/extended/d05s05e.rpy:29
translate deutsch d05s05e_7c58c44d:

    # mct "And she was on the party!"
    mct "Und sie war auf der Party!"

# game/code/d05/extended/d05s05e.rpy:34
translate deutsch d05s05e_524a93b7:

    # mct "She was taking a photo of her pussy."
    mct "Sie hat ein Photo ihrer Pussy gemacht."

# game/code/d05/extended/d05s05e.rpy:39
translate deutsch d05s05e_fed4898b:

    # mct "In fact, I ate her pussy out on the balcony later that night!"
    mct "Tatasache ist, Ich habe später ihre Pussy auf dem Balkon geleckt!"
...
translate deutsch d05s05e_eb0dcf0f:
    ...
    mct "5 Punkte nur um ihr eine Nachricht zu senden?"
...
translate deutsch d05s05e_9bec7a24:
    ...
    mct "Und dieser Username? -  dein kleines Pony. Möchte ich wirklich wissen was das bedeutet?"
...
translate deutsch d05s05e_abeca518:
    ...
    mcfl "{i}Hey URLittlePony, Ich bin [mclogin]. Wir sollten mal reden.{/i}"
...
translate deutsch d05s05e_ccb3278c:
    ...
    mcfl "{i}Warum solltest du vor mir Angst haben?{/i}"
...
translate deutsch d05s05e_d900f650:
    ...
    jffl "{i}Das kann ich verstehen. Ist eine weitere Party geplant?{/i}"

# game/code/d05/extended/d05s05e.rpy:85
translate deutsch d05s05e_3d361581:

    # mcfl "{i}Not that I know of. Maybe.{/i}"
    mcfl "{i}Nicht das ich wüsste. Vielleicht.{/i}"

# game/code/d05/extended/d05s05e.rpy:86
translate deutsch d05s05e_2a0ec449:

    # jffl "{i}You need more points?{/i}"
    jffl "{i}Du brauchst mehr Punkte?{/i}"

# game/code/d05/extended/d05s05e.rpy:87
translate deutsch d05s05e_40d60841:
...
translate deutsch d05s05e_f6abb886:
    ...
    mcfl "{i}Sicher, an was denkst du?{/i}"
...
translate deutsch d05s05e_9690e6b4:
    ...
    mcfl "{i}Ich bin morgen verplant.{/i}"
...
translate deutsch d05s05e_0c720c99:
    ...
    mcfl "{i}Klingt super. Bis morgen dann!{/i}"

# game/code/d05/extended/d05s05e.rpy:97
translate deutsch d05s05e_c4f06cb7:
