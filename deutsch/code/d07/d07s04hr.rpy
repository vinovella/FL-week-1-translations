...
translate deutsch replay_d07s04hr_aa156988:
    ...
    mct "OK, ich bin fast wieder an unserem Platz am Strand."
...
translate deutsch replay_d07s04hr_4f3c5e9b:
    ...
    mct "Ich muss tot sein. Ich fahre einen Jetski gleichzeitig mit einem brandheißen nackten Mädchen."
...
translate deutsch replay_d07s04hr_3d7d35a1:
    ...
    mct "Wie könnte ich nur abgelenkt sein? Wir sind offensichtlich kurz davor, Sex zu haben."
...
translate deutsch replay_d07s04hr_fb5d8cbe:
    ...
    hr "Ich weiß von Fetisch Locator. Ich weiß, dass du im Bindungsprogramm bist."
...
translate deutsch replay_d07s04hr_af573dc5:
    ...
    hr "Du bist nicht der einzige. Es gibt andere, die von diesem Programm ausgenutzt werden. Ich werde sie bloßstellen."

# game/code/d07/d07s04hr.rpy:53
translate deutsch replay_d07s04hr_5d0ba665:

    # mc "Speaking of being exposed... should I undress?"
    mc "Apropos Entblößung... sollte ich mich ausziehen?"
...
translate deutsch replay_d07s04hr_17c2a025:
    ...
    hr "Nein. Ich werde die Leute hinter Fetish Locator auffliegen lassen. Ich habe schon einen von ihnen aufgespürt."
...
translate deutsch replay_d07s04hr_0c6b89fa:
    ...
    hr "Wirklich? Warum also kann die Fetish Locator App auf seinem Handy auch auf die Bilder von anderen Leuten zugreifen?"
...
translate deutsch replay_d07s04hr_726aacd7:
    ...
    hr "Die Fetish Locator Bilder - die Bilder die du oder irgendjemand anderes hochlädt - Ich kann sie durch Pete's Handy ansschauen."

# game/code/d07/d07s04hr.rpy:73
translate deutsch replay_d07s04hr_a2d09c05:

    # mc "How do you have Pete's phone?"
    mc "Wie kommst du an Pete's Handy?"
...
translate deutsch replay_d07s04hr_a490796c:
    ...
    hr "Ich habe es letzte Woche geklont, als ich so getan habe, als würde ich auf ihn stehen."

# game/code/d07/d07s04hr.rpy:77
translate deutsch replay_d07s04hr_843c85aa:

    # mc "You sucked his dick to get a copy of his phone?"
    mc "Du hast seinen Schwanz gelutscht, um eine Kopie von seinem Handy zu bekommen?"
...
translate deutsch strings:
    ...
    new "Versuch noch etwas abzukriegen bevor du gehst"
...
translate deutsch replay_d07s04hr_db374e28:
    ...
    hr "Das ist eines der Videos, die ich von seinem Handy gezogen habe. {w} Ich lass dich damit allein."
...
translate deutsch d07s04hr_part_2_3c6af36a:
    ...
    hr "Ich bin... {w}Schau, jemand der mir nahe steht wurde in das Bindungsprogramm gelockt. Ich werde sie da rausholen und sicherstellen, dass niemand anderes verletzt wird."
...
translate deutsch d07s04hr_part_2_47398d41:
    ...
    hr "Okay. Ich bin eine Journalismusstudentin und möchte mir einen Namen machen, bevor ich meinen Abschluß mache und in einer Poststelle lande."

# game/code/d07/d07s04hr.rpy:119
translate deutsch d07s04hr_part_2_f3a069d2:

    # mc "Your first story was better."
    mc "Deine erste Geschichte war besser."
...
translate deutsch d07s04hr_part_2_11935428:
    ...
    hr "Es macht keinen Unterschied wer ich bin. Ich bin deine beste Option aus der Erpressung des Bindungsprogramms zu kommen. Wie klingt das?"
...
translate deutsch d07s04hr_part_2_28ef734e:
    ...
    mc "Warum erzählst du mir das? Was brauchst du von mir?"
...
translate deutsch d07s04hr_part_2_86d2294d:
    ...
    hr "Du bist Pete's Mitbewohner. Du hast Zugang zu seinem Zimmer, seinen Sachen, seinem Laptop..."
...
translate deutsch d07s04hr_part_2_045aca7c:
    ...
    hr "Denkst du, es hat mir gefallen, diesem Arsch einen zu blasen?"
...
translate deutsch d07s04hr_part_2_8de6204c:
    ...
    hr "Fick dich. Ich muss das Passwort für seinen Laptop herausfinden."
...
translate deutsch d07s04hr_part_2_516f7c20:
    ...
    hr "Du musst jeden Tag ein Passwort probieren bis, du das richtige findest."
...
translate deutsch d07s04hr_part_2_c68f0c66:
    ...
    hr "Ich habe eine Liste. Ich weiß, dass es eine von fünf Möglichkeiten ist. Du musst dir das hier merken."
...
translate deutsch d07s04hr_part_2_f8f48f8a:
    ...
    mc "Du gehst jeden Abend laufen. Morgen werde ich im Park sein. Du gibst mir das Stück Papier..."
...
translate deutsch d07s04hr_part_2_728cae01:
    ...
    hr "Das würde funktionieren aber es würde auch bedeuten, dass du erst morgen anfangen kannst."
...
translate deutsch d07s04hr_part_2_c78c5bca:
    ...
    mc "Naja, ich kann versuchen sie mir zu merken, aber ich bezweifle dass das viel bringt."

# game/code/d07/d07s04hr.rpy:158
translate deutsch d07s04hr_part_2_6610c340:

    # hr "You're really not that bright, huh?"
    hr "Du bist wirklich nicht der Hellste, huh?"
...
translate deutsch d07s04hr_part_2_880f57e8:
    ...
    mc "Wenn Pete die Liste findet, schiebe ich es auf Samiya."
...
translate deutsch d07s04hr_part_2_961e5e85:
    ...
    mc "Sie ist eine diebische Schlampe, die Pete gefick hat und auf der er eingeschlafen ist."

# game/code/d07/d07s04hr.rpy:170
translate deutsch d07s04hr_part_2_1e337853:

    # hr "Okay. That will work."
    hr "Okay. Das wird gehen."
...
translate deutsch d07s04hr_part_2_a3acc06f:
    ...
    mc "Warte mal. Ich helfe dir, also warum hilfst du mir nicht..."
...
translate deutsch d07s04hr_part_2_92460e18:
    ...
    hr "Willst du mich verarschen? Du wirst erpresst. Ich helfe dir."
...
translate deutsch d07s04hr_part_2_32f02821:
    ...
    hr "Ich glaube, du kannst von hier aus zurück zum Strand schwimmen."
...
translate deutsch replay_d07s04hr_d76b4e19:
    ...
    hr "Ich kenne Fetisch Locator und das VIP Fetish Challenge Programm."

# game/code/d07/d07s04hr.rpy:76
translate deutsch replay_d07s04hr_17c733b7:

    # hr "You're not the only one. There are other people being in the same Program."
    hr "Du bist nicht der Einzige. Es gibt noch andere Leute, die im selben Programm sind."

# game/code/d07/d07s04hr.rpy:77
translate deutsch replay_d07s04hr_e28af91b:

    # hr "The program is not all it says it is. You can't just win by doing the challenges."
    hr "Das Programm hält nicht alles, was es verspricht. Du kannst nicht einfach gewinnen, indem du die Herausforderungen meisterst."

# game/code/d07/d07s04hr.rpy:88
translate deutsch replay_d07s04hr_1d0abf41:

    # mc "What? What are you talking about?"
    mc "Was? Wovon redest du?"

# game/code/d07/d07s04hr.rpy:94
translate deutsch replay_d07s04hr_a5fa8999:

    # hr "I'm sure you've gotten the message saying that \"the treasure is always within Fetish Locator.\""
    hr "Ich bin sicher, du hast die Nachricht erhalten, dass \"der Schatz immer im Fetisch Locator ist.\""

# game/code/d07/d07s04hr.rpy:95
translate deutsch replay_d07s04hr_c3d98f0b:

    # hr "That's not just some saying. It's a clue. We need to figure out who is running this app to win this."
    hr "Das ist nicht nur eine Behauptung. Es ist ein Hinweis. Wir müssen herausfinden, wer diese App betreibt, um zu gewinnen."

# game/code/d07/d07s04hr.rpy:96
translate deutsch replay_d07s04hr_cee543d0:

    # hr "And I've tracked down one of them already."
    hr "Und einen davon habe ich bereits aufgespürt."

# game/code/d07/d07s04hr.rpy:151
translate deutsch d07s04hr_part_2_0bfa7621:
    ...
    hr "Ich bin... {w}Schau, jemand aus meinem Umfeld nimmt am selben Programm teil. Ich möchte, dass sie gewinnt oder zumindest einen Teil des Gewinns erhält und ich werde alles dafür tun, dass das klappt."

# game/code/d07/d07s04hr.rpy:163
translate deutsch d07s04hr_part_2_54e2cf35:

    # hr "It doesn't matter who I am. I'm your best chance of actually winning this thing. How's that?"
    hr "Es ist egal, wer ich bin. Ich bin deine beste Chance, das Ding tatsächlich zu gewinnen. Wie klingt das?"

# game/code/d07/d07s04hr.rpy:168
translate deutsch d07s04hr_part_2_26f00981:

    # mc "Why are you telling me this? If you know so much, you could win this yourself. Why do you need me?"
    mc "Warum erzählst du mir das? Wenn du so viel weißt, könntest du das selbst gewinnen. Wozu brauchst du mich?"

# game/code/d07/d07s04hr.rpy:229
translate deutsch d07s04hr_part_2_2b74728c:

    # hr "Are you kidding me? I {i}{b}am{/b}{/i} helping you."
    hr "Willst du mich verarschen? {i}{b}Ich{/b}{/i}helfe dir."
