...
translate deutsch replay_d07s04hr_df595444:
    ...
    mct "Nicht schlecht. Das würde ich gerne ausprobieren. Ich wundere mich ob die Jet-Skis verleihen."
...
translate deutsch replay_d07s04hr_4f3c5e9b:
    ...
    mct "Ich muss tot sein. Ich fahre einen Jetski und habe Sex mit einem brandheißen Mädchen gleichzeitig."
...
translate deutsch replay_d07s04hr_3379b788:
    ...
    mct "Vielleicht bin ich ja dabei gestorben während ich etwas im Wasser bekämpft habe und sie ist eine Walküre."
...
translate deutsch replay_d07s04hr_eb5b9efa:
    ...
    hr "Alles klar, da sind wir. Kletter an Bord."
...
translate deutsch replay_d07s04hr_3d7d35a1:
    ...
    mct "Wie könnte ich jemals abgelenkt werden. Wir sind offensichtlich kurz davor Sex zu haben."
...
translate deutsch replay_d07s04hr_fb5d8cbe:
    ...
    hr "Ich weiß von Fetisch Locator. Ich weiß, dass du im Bewährungsprogramm bist."
...
translate deutsch replay_d07s04hr_af573dc5:
    ...
    hr "Du bist nicht der einzige. Es gibt andere die von diesem Programm ausgenutzt werden. Ich werde sie auffliegen lassen."

# game/code/d07/d07s04hr.rpy:53
translate deutsch replay_d07s04hr_5d0ba665:

    # mc "Speaking of being exposed... should I undress?"
    mc "Wo wir gerade davon reden... sollte ich mich ausziehen?"
...
translate deutsch replay_d07s04hr_17c2a025:
    ...
    hr "Nein. Ich werde die Leute hinter Fetish Locator auffliegen lassen. Ich habe schon einen davon aufgespürt."
...
translate deutsch replay_d07s04hr_adb8749f:
    ...
    mc "Bullshit. Pete hat damit nichts zu tun."
...
translate deutsch replay_d07s04hr_0c6b89fa:
    ...
    hr "Wirklich? Also warum kann die Fetish Locator app auf seinem Handy auch die Bilder von anderen Leuten aufrufen?"
...
translate deutsch replay_d07s04hr_a2d09c05:
    ...
    mc "Wie hast du Zugriff auf Pete's Handy?"
...
translate deutsch replay_d07s04hr_67657d9a:
    ...
    mc "Warum kannst du es nicht auf ein Stück Papier schreiben?"

# game/code/d07/d07s04hr.rpy:118
translate deutsch replay_d07s04hr_5db6a2c7:

    # hr "You are going swimming, remember?"
    hr "Du gehst gleich schwimmen, schon mal dran gedacht?"
...
translate deutsch replay_d07s04hr_c78c5bca:
    ...
    mc "Naja, ich kann versuchen sie mir zu merken aber ich glaube nicht dass das viel bringt."
...
translate deutsch replay_d07s04hr_db374e28:
    ...
    hr "Das ist eines der Videos die ich von seinem Handy geklaut habe. {w} Ich lass dich damit allein."
...
translate deutsch d07s04hr_part_2_28ef734e:
    ...
    # mc "Why are you telling me this? What do you need from me?"
    mc "Warum erzählst du mir das alles? Was brauchst du von mir?"
...
translate deutsch d07s04hr_part_2_045aca7c:
    ...
    hr "Denkst du es hat mir gefallen dem kleinen Scheißer einen zu blasen?"
...
translate deutsch d07s04hr_part_2_32f02821:
    ...
    hr "Ich glaube du kannst von hier zum Strand zurückschwimmen."
...
translate deutsch d07s04hr_part_2_cd73084d:
    ...
    hr "So ungefähr. Es ist nicht weit - du kannst den Strand schon sehen."
