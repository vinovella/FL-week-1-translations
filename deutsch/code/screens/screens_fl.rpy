translate deutsch strings:
    ...
    new "Es wurde kein Speicherstand von Woche [FLSS.week.prev] gefunden"
...
translate deutsch strings:
    ...
    new "Bitte trage unten einen Namen für den Speicherstand ein und klicke Speichern"

    # game/code/screens/screens_fl.rpy:65
    old "This will allow you to start week 2 without losing your progress"
    new "Dies erlaubt dir Woche 2 zu starten, ohne deinen Fortschritt zu verlieren"
...
translate deutsch strings:
    ...
    new "Touch-Eingabe wird unterstützt"
    ...
    new "Du findest dieses Layout im {b}Hilfemüne{/b}"
    ...
    new "Dein Gerät kann den Spielfortschritt über verschiedene Wochen nicht speichern. Bitte erlaube der FL App, auf den externen Speicher zu schreiben."

    # game/code/screens/screens_fl.rpy:434
    old "On most devices you can set the permissions on the Setting app."
    new "Auf den meisten Geräten kannst du die Berechtigungen in der Einstellungs-App festlegen."

    # game/code/screens/screens_fl.rpy:435
    old "1. Go to - Settings -> Apps -> Fetish Locator Week [FLSS.week.cur] -> Permissions -> Storage."
    new "1. Gehe zu - Einstellungen -> Apps -> Fetish Locator Week [FLSS.week.cur] -> Berechtigungen -> Speicher."

    # game/code/screens/screens_fl.rpy:436
    old "2. Set the permission to -> \"Allow management of all files\"."
    new "2. Setze die Berechtigung auf -> \"Verwaltung aller Dateien zulassen\"."

    # game/code/screens/screens_fl.rpy:438
    old "Now the game should work."
    new "Jetzt sollte das Spiel funktionieren."
    ...
    new "Dein Gerät kann den Spielfortschritt über verschiedene Wochen hinweg nicht speichern. Befolge die Anweisungen, um das Problem zu behen."

    # game/code/screens/screens_fl.rpy:442
    old "1. Enable \"Show hidden items\" option in Windows Explorer."
    new "1. Aktiviere die Option \"Ausgeblendete Elemente anzeigen\" im Windows Explorer."

    # game/code/screens/screens_fl.rpy:443
    old "2. Go to - \"C:/Users/username/AppData/Roaming/RenPy/persistent/\" folder."
    new "2. Gehe zum Ordner - \"C:/Users/username/AppData/Roaming/RenPy/persistent/\"."

    # game/code/screens/screens_fl.rpy:444
    old "3. Create a backup of the file \"FetishLocator\" and delete it."
    new "3. Erstelle eine Sicherungskopie der Datei \"FetishLocator\" und lösche die Datei."
    ...
    new "4. Nachdem du das Spiel einmal gestartet hast, kannst du die gesicherte Datei wieder an ihren Spiecherort zurücklegen, um die Wochenspeicherstände wiederherzustellen."
