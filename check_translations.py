...
folders = ("./deutsch", "./italian", "./russian", "./spanish", "./chinese", "./portuguese", "./french")
has_latin_characters = {"deutsch":True, "italian":True, "russian":False, "spanish":False, "chinese":False, "portuguese":False, "french":False}
