...
translate korean s04_0afa175b:

    # mct "There's Pete."
    mct "피트가 왔네."

# game/code/d01/s04.rpy:118
translate korean s04_669664cb:

    # mc "Hey."
    mc "어이."

# game/code/d01/s04.rpy:123
translate korean s04_e0ad8b16:
...
translate korean s04_a3eeb706:
    ...
    mc "맘 쓰지 마. 어쩌면 다음번엔 내가 여자애를 데려 올 수도 있잖냐. 그땐 네가 도와줘야지."
...
translate korean s04_7407f7c1:
    ...
    mc "아, 지금도 컴퓨터는 엄청 잘 다뤄, 그렇지만 지금은 달리기도 시작했고, 요가도 하고, 그런 운동 같은 것도 다 하더라. 그런 걸 다 할 시간은 어떻게 만들었나 몰라."
...
translate korean replay_d01s04_4ed58fa4:
    ...
    pb "아, 너도 벌써 들었구나. 그래, 그년은 점수 좀 벌려고 혈안이 됐더라."
...
translate korean replay_d01s04_361d9674:
    ...
    pb "그래, 맞아. 오늘의 페티시 승자는 이미 정해졌지. 사실 오늘은 꽤 빨리 정해진 편이걸랑."
...
translate korean replay_d01s04_f65bbde0:
    ...
    pb "그래도 앱에 후끈한 물건을 올리면 언제든지 점수를 벌 수 있어. 오늘의 페티시에 관련된 거기만 하면 말이야."
...
translate korean replay_d01s04_c001942c:
    ...
    pb "음, 그거 때문만은 아니고. 이 앱에는 점수로 뭘 살 수 있는 상점이 있거든."
...
translate korean replay_d01s04_d18429d4:
    ...
    pb "상점에서 살 수 있는 것 중 하나가 파티에 참석할 수 있는 표야. 이틀 뒤면 파티가 열리는데, 그 파티에 리디아도 올 거라는 정보를 구했지."

# game/code/d01/s04.rpy:436
translate korean replay_d01s04_9e891473:

    # mc "She's using the app too?!"
    mc "리디아도 이 앱을 쓰는 거야?!"

# game/code/d01/s04.rpy:438
translate korean replay_d01s04_5c557e0e:

    # pb "I'm sure she's probably using it."
    pb "분명히 걔도 이 앱을 쓰고 있을걸."
...
translate korean replay_d01s04_2da0ad6e:
    ...
    mct "피트한텐 그 점수를 딴 사람들이 누구인진 알려 주지 말아야겠지."
...
translate korean replay_d01s04_5410f6a9:
    ...
    pb "오늘 도전의 승자 나왔잖냐. 걔들도 그걸론 딱 한 번만 점수를 받을 수 있다고."
...
translate korean replay_d01s04_0376ba43:
    ...
    pb "그렇게 할 수 있긴 하지만, 파티 표를 사려면 점수 절반은 사는 게 아니라 네가 직접 따야 돼."
...
translate korean replay_d01s04_5b237915:

    # pb "I gotta run. There's some celebration planned for the team. Later!"
    pb "난 가야겠다. 승리 축하 행사 같은 게 있거든. 나중에 보자!"
...
translate korean replay_d01s04_ff2ff749:
    ...
    mct "바보 같은 계획이긴 하지만, 해 봐서 손해 볼 건 없겠지?"
...
translate korean replay_d01s04_bdaff425:
    ...
    mct "오늘의 페티시는 컴샷이야. 내가 이해한 게 맞다면, 이거랑 관련된 걸 올려야 돼."
...
translate korean replay_d01s04_18c318ba:
    ...
    mct "그냥 샤워하면서 딸치는 걸로는 충분하지 않을 거야. 뭔가... 인상적인 걸 해야 될 텐데."
...
translate korean replay_d01s04_325c4b97:
    ...
    mct "앰로즈랑 영화 보기로 약속했었지. 점수를 따려면 뭐라도 해야 해. 하지만 같이 영화를 보지 않으면 앰로즈가 엄청 화낼텐데."

translate korean strings:

    # game/code/d01/s04.rpy:210
    old "That is my [game.stacytitle]! Should give her some privacy"
    new "[game.stacytitle]한테 무슨 마음을 품는 거냐! 사생활을 지켜 줘야한다"
    ...
    new "약속대로 앰로즈랑 같이 영화를 본다"

    # game/code/d01/s04.rpy:485
    old "Don't go to AmRose and try to earn some points"
    new "앰로즈를 보러 가지 않고 점수를 따 보려고 한다"
