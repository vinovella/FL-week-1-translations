...
translate korean d03s16_9fc736db:
...
translate korean d03s16_1b097a51:
    ...
    lc "하지만 계속 의문이 들어... {w}내가 왜 여기에 있을까?"
...
translate korean d03s16_dec76dcd:

    # mct "Why did that asshole have to interrupt us and take her away?!"
    mct "왜 저 씹새끼가 우리를 방해하고 리디아를 데려간 거지?!"

# game/code/d03p2/d03s16.rpy:87
translate korean d03s16_1e4a57b7:

    # mct "Be cool, be cool. She noticed me. We spoke."
    mct "침착하자, 침착해. 리디아가 날 알아봤어. 우린 이야기를 했고."

# game/code/d03p2/d03s16.rpy:88
translate korean d03s16_f27ab0da:
...
translate korean d03s16_e1eee63f:

    # mh "Earlier?"
    mh "아까?"

# game/code/d03p2/d03s16.rpy:179
translate korean d03s16_2ae50391:
...
translate korean d03s16_912bb886:
...
translate korean d03s16_2cfdf1bb:
    ...
    amfl "부디 더 많은 초대에 응해주시길 바랍니다."

# game/code/d03p2/d03s16.rpy:271
translate korean d03s16_2a9ad3e8:

    # amfl "Perhaps the lovely Lyssa might even join us next time."
    amfl "어쩌면 사랑스러운 리사 양께서 다음번엔 저희와 함께 해주실지도 모르겠군요."

# game/code/d03p2/d03s16.rpy:272
translate korean d03s16_9c940590:
...
translate korean d03s16_5a9545ca:
...
translate korean replay_d03s16_086843f4:
    ...
    amfl "부디 이곳에 모여주시길 바랍니다! 본 행사가 곧 시작합니다!"

# game/code/d03p2/d03s16.rpy:302
translate korean replay_d03s16_37e680a1:

    # mct "Oh. There is Lydia!"
    mct "오. 저기 리디아가 있네!"

# game/code/d03p2/d03s16.rpy:305
translate korean replay_d03s16_682e01e0:

    # mct "Fuck! She is with this guy again! Who is that jerk?!"
    mct "씨발! 리디아가 저 새끼랑 또 같이 있잖아! 저 등신은 도대체 누구야?!"
...
translate korean replay_d03s16_6d25d30b:
    ...
    amfl "저희가 비록 가면을 쓰고 있다고 하더라도 여러분 대부분은 저희가 누구인지 아실 겁니다."

# game/code/d03p2/d03s16.rpy:312
translate korean replay_d03s16_abd0e602:
    ...
    amfl "저희가 올해 초 결별을 고했다는 사실도 알고 계시겠지요. 저희의 관계가 서로에 대한 열정을 상실한 국면에 이르렀기 때문입니다."
...
translate korean replay_d03s16_33f8a53b:
    ...
    amfl "제가 페티시 로케이터를 발견했을 때조차도 저희가 이 앱에 의해 다시 함께 하리라곤 생각도 못했습니다. {w}그러나 페티시 로케이터의 도전 중 하나를 수행하는 과정에서 저는 [mesfl]의 연락을 받았습니다."
...
translate korean replay_d03s16_7bc17a08:
    ...
    amfl "그리하여 저희가 다시 함께 하는 것을 축하하기 위해 그리고 페티시 로케이터에 감사를 표하기 위해 저희는 이 변태적인 파티를 개최하기로 결정했던 것입니다!"
...
translate korean replay_d03s16_7ab4ae49:

    # amfl "We might have this as a regular event!"
    amfl "우리는 정기적인 행사로 이런 파티를 가질 수 있을 겁니다!"
...
translate korean replay_d03s16_de67bc47:
...
translate korean replay_d03s16_9ec19b68:
    ...
    amfl "그러나, 그녀는 기꺼이 이 일에 동의하였습니다, 그렇지 자기?"

# game/code/d03p2/d03s16.rpy:371
translate korean replay_d03s16_32250e25:
...
translate korean replay_d03s16_0af1ca87:
...
translate korean replay_d03s16_7ecff610:

    # mct "It is very dark, but everyone seems to be enjoying the show!"
    mct "엄청 어둡긴 하지만, 모두 이 장관을 즐기는 것 같네!"
...
translate korean replay_d03s16_d1e009d7:

    # mct "Wow! What the fuck?! What the fuck is he doing?!"
    mct "와! 뭐야 씨발?! 저 씨팔놈이 뭘 하고 있는 거야?!"
