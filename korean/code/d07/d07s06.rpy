...
translate korean d07s06_f31eaa7d:

    # mc "Red?"
    mc "빨간색?"

# game/code/d07/d07s06.rpy:45
translate korean d07s06_da1bc4ea:
...
translate korean d07s06_26493570:
    ...
    mc "{i}지금부터 내가 다른 말을 하기 전까진, 입에 오줌을 머금을 때만 갈 수 있어.{/i}"
...
translate korean d07s06_c85e6d0b:
    ...
    mh "{i}알려 줘서 고마워. 오늘 화내서 미안해. 나에겐 그렇게 단순한 문제가 아니라서 그랬다는 걸 이해해 주길 바라.{/i}"
...
translate korean d07s06_7116c168:
    ...
    mh "{i}그래도 그 직전까지 일어난 일은 마음에 들었어. 함께 시간을 더 보내고 싶어. 아마 다음엔 사적인 공간에서?{/i}"
...
translate korean d07s06_later_a8eff729:

    # mct "What the...?"
    mct "뭐야...?"

# game/code/d07/d07s06.rpy:187
translate korean d07s06_later_2a609592:

    # mct "Oh it seems like I finally got all my points for today..."
    mct "아 오늘 딴 점수를 이제 다 받은 모양이네..."

# game/code/d07/d07s06.rpy:192
translate korean d07s06_later_1ff5728b:

    # mct "I got [d07s04_dd_points] for spanking Daisy."
    mct "데이지 엉덩이를 때린 걸로 [d07s04_dd_points]점 받았네."

# game/code/d07/d07s06.rpy:197
translate korean d07s06_later_7f2229fe:

    # mct "I got [d07s04_dw_points] for Dahlia spanking me."
    mct "달리아가 내 엉덩이를 때린 걸로 [d07s04_dw_points]점 받았네."
...
translate korean d07s06_later_355a83d1:
    ...
    flr "에리카레드의 현재 목표 달성을 위해 점수를 전송하시겠습니까?"

# game/code/d07/d07s06.rpy:253
translate korean d07s06_later_0454601a:

    # mct "Wait, Fetish Locator is asking if I want to help AmRose?"
    mct "잠깐, 페티시 로케이터가 앰로즈를 돕고 싶냐고 물어보는 거야?"
...
translate korean d07s06_later_7f4d5a75:
    ...
    mct "따지고 보면 그렇게 미친 건 아니었네..."

# game/code/d07/d07s06.rpy:278
translate korean d07s06_later_d882f22b:

    # flr "You have [fl_extra_points] remaining."
    flr "[fl_extra_points]점이 남아 있습니다."
...
translate korean d07s06_gameover_818f4392:
    ...
    "해설자" "당국은 앱 배후에 누가 있는지 확인할 수 없었습니다."
...
translate korean strings:
    ...
    new "에리카레드에게 25점을 전송한다"

    # game/code/d07/d07s06.rpy:257
    old "Transfer 10 Points to ErikaRed"
    new "에리카레드에게 10점을 전송한다"
