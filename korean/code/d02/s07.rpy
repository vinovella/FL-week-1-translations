...
translate korean d02s07_ccc6009a:
    ...
    "[mcname] 녀석은 구내식당에 도착한다. 짧은 줄이 끝나고 바나나 한 개를 구한다. "
...
translate korean d02s07_aa5d1abb:

    # mct "So, that's where Pete is!"
    mct "그래, 피트 녀석 어디 갔나 했더니. 저기에 있었네!"

# game/code/d02/s07.rpy:110
translate korean d02s07_e55888cb:

    # mc "Hey, Pete!"
    mc "야, 피트!"

# game/code/d02/s07.rpy:112
translate korean d02s07_6e272b01:

    # pb "[mcname]! Hey!"
    pb "[mcname]! 어이!"

# game/code/d02/s07.rpy:113
translate korean d02s07_dd58f4f5:

    # mc "Is it your breakfast?"
    mc "그게 니 아침이냐?"

# game/code/d02/s07.rpy:115
translate korean d02s07_02b31895:
...
translate korean d02s07_1f9c1d0e:
    ...
    mc "({i}갑자기 생각났는데... 내 [game.stacytitle]도 여기에 오면 분명히 페티시 로케이터가 뭔지 알게 될 거란 말이지, 여기서는 모두가 그 앱을 쓰니까. 그럼 걔도 이걸 쓸까?!{/i})"
...
translate korean replay_d02s07_b50077a0:
    ...
    mc "({i}소파에서 자는 건 끔찍해! 벌써 기숙사 침대가 그리워지네!{/i})"
...
translate korean replay_d02s07_c3b6099b:

    # mct "Is everyone still sleeping?"
    mct "아직도 다들 자나?"

# game/code/d02/s07.rpy:186
translate korean replay_d02s07_eca82bf1:

    # mct "Great! The door is open! The shower shall be mine!"
    mct "훌륭해! 비어 있구만. 샤워는 나의 것이 되리라!"

# game/code/d02/s07.rpy:192
translate korean replay_d02s07_b5fc3d66:

    # mct "Strange... I hear the shower running."
    mct "이상한걸... 샤워 소리가 들리잖아."

# game/code/d02/s07.rpy:200
translate korean replay_d02s07_f0042343:
...
translate korean replay_d02s07_63f812be:
    ...
    mc "({i}세상천지에 누가 문을 열어 놓고 샤워를 해?!{/i})"
...
translate korean replay_d02s07_4355860f:
    ...
    mc "({i}또 내 [game.stacytitle] 보고 있게 됐네. 게다가 이번에는 정말로 벗고 있잖아!{/i})"
...
translate korean replay_d02s07_db0389aa:

    # mc "({i}She is my [game.stacytitle]! I should leave immediately!{/i})"
    mc "({i}내 [game.stacytitle]한테 무슨 생각을 하는 거냐! 지금 나가야 돼!{/i})"

# game/code/d02/s07.rpy:216
translate korean replay_d02s07_f9ea10f1:

    # mct "I will just open the door a little bit more!"
    mct "난 그냥 문을 조금 더 열 뿐이라고!!"

# game/code/d02/s07.rpy:220
translate korean replay_d02s07_87cb12c3:

    # mct "Wow! I see Stacy naked!"
    mct "와! 내가 스테이시 알몸을 보게 되다니!"

# game/code/d02/s07.rpy:221
translate korean replay_d02s07_a2c85cd6:

    # mc "({i}I will watch just a little bit more!{/i})"
    mc "({i}그냥 조금만 더 볼 뿐이야!{/i})"
...
translate korean replay_d02s07_af60218e:

    # mct "I pee in the shower too. But should I watch how she does it?"
    mct "나도 샤워 중에 오줌을 싸긴 하지. 그래도 스테이시가 그러는 걸 봐야 할까?"

# game/code/d02/s07.rpy:248
translate korean replay_d02s07_a7b96636:
...
translate korean replay_d02s07_a8656b26:
    ...
    mct "내가 왜 샤워하다가 오줌 싸는 걸 보고 싶어 하는 거지? 왜 [game.stacytitle]한테 이런 마음을 품는 거야?"
...
translate korean replay_d02s07_f8eec004:
    ...
    mc "({i}지금 [game.stacytitle]한테 들키면, 샤워하는 걸 훔쳐봤을 뿐만 아니라, 오줌 싸면서 자위하는 걸 훔쳐본 게 된다고!{/i})"
...
translate korean replay_d02s07_e99614ac:
    ...
    mc "({i}내 [game.stacytitle] 보고 발기를 했어. 이건 정말 못된 짓인데, 그대로 진짜 엄청나게 꼴려!{/i})"
...
translate korean replay_d02s07_f71e9b49:
    ...
    "그녀는 오른손으로 왼쪽 젖꼭지를 잡고 왼손이 아래로 내려갈 때마다 젖꼭지를 앞으로 잡아당기기 시작한다."
...
translate korean replay_d02s07_919f3d91:
    ...
    "엉덩이가 젖은 바닥에 닿자 그녀의 입에서 쾌락에 찬 탄성이 흘러나온다."

# game/code/d02/s07.rpy:303
translate korean replay_d02s07_9731f864:

    # sy "A-a-a-h"
    sy "아-아-아-앗"

# game/code/d02/s07.rpy:307
translate korean replay_d02s07_ae0e3462:

    # "Stacy’s body starts to shake in orgasmic spasms!"
    "스테이시의 몸은 절정의 경련으로 떨리기 시작한다!"

# game/code/d02/s07.rpy:315
translate korean replay_d02s07_5c25b3ee:

    # sy "O-o-o-h"
    sy "오-오-오-옷"

# game/code/d02/s07.rpy:316
translate korean replay_d02s07_2d8f6d5d:

    # "After bursting in orgasm her muscles relaxed and she continued falling onto her back"
    "절정이 터지자 스테이시의 근육은 이완되고 스테이시는 뒤로 무너진다"

# game/code/d02/s07.rpy:337
translate korean replay_d02s07_d7f7bcb2:

    # mct "I... {w}think I... {w}came in my pants... {w} That was amazing!"
    mct "내... {w}생각엔... 내가 {w}바지에 싼 것 같아... {w} 존나 쩐다!"
...
translate korean replay_d02s07_c2ae07eb:
    ...
    mc "({i}이제 이 바나나를 가지고 뭘 하는지 알아볼 시간이군.{/i})"

# game/code/d02/s07.rpy:371
translate korean d01s07_pete_about_girls_fcc1b776:

    # pb "Hmmm, what was I talking about?"
    pb "으으음, 내가 무슨 말을 하고 있었더라?"

# game/code/d02/s07.rpy:372
translate korean d01s07_pete_about_girls_16af2776:

    # mc "The party."
    mc "그 파티."

# game/code/d02/s07.rpy:377
translate korean d01s07_pete_about_girls_2854182f:
    ...
    pb "아, 맞다! 파티엔 진짜 미친년들도 있더라니까! 우리 대학 애들도 아니라서 페티시 로케이터 앱에 관해선 전혀 알지도 못하는데도 별짓을 다하던데! 우리가 같이 해 보자고 걔들한테 앱을 보여 줘야 했다니까!"
...
translate korean d01s07_pete_about_girls_2_0741f128:
    ...
    pb "바로 그년의 그 예쁜 금발 머리 위에 샀다니까! 믿겨지냐?! 이거 정말 졸라 엄청 쩔었어!"

# game/code/d02/s07.rpy:393
translate korean d01s07_pete_about_girls_2_5b5eb208:
