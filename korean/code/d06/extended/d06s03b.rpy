...
translate korean d06s03b_31b26680:

    # mct "Ah, there she is."
    mct "아, 저기에 있네."

# game/code/d06/extended/d06s03b.rpy:7
translate korean d06s03b_797ed68c:

    # mc "We never met properly. I'm [mcname]."
    mc "제대로 인사를 못했네. 난 [mcname]."
...
translate korean d06s03b_32bab977:

    # mc "You want to see it?"
    mc "사진을 보고 싶어?"

# game/code/d06/extended/d06s03b.rpy:39
translate korean d06s03b_b11c47a4:
...
translate korean d06s03b_8a61639f:

    # mc "But... {w}I kinda want to know why you were naked in that apartment?"
    mc "그런데... {w}난 네가 왜 아파트에서 벌거벗고 있었는지 좀 알고 싶은데?"
...
translate korean d06s03b_f23fa052:
    ...
    jf "뭐? 아냐, 너처럼 그냥 학생이라구."

# game/code/d06/extended/d06s03b.rpy:68
translate korean d06s03b_72b032ae:
...
translate korean d06s03b_80425743:
    ...
    jf "음, 난 이 앱에서 말도 안 되는 점수를 따는 방법이 있다고 들었어, 그래서 그랬던 거야."

# game/code/d06/extended/d06s03b.rpy:84
translate korean d06s03b_27e8d8c3:
...
translate korean d06s03b_d5f145e4:

    # jf "Oh! It was filthy there. I couldn't help myself."
    jf "아! 거긴 더러웠거든. 그래서 참을 수가 없었어."
...
translate korean d06s03b_76cfba13:
    ...
    jf "내 옷을 더럽히고 싶진 않았어, 그래서 주체할 수가 없었어. 그래서 청소 같은 걸 하기 시작했어."
...
translate korean d06s03b_b32767f4:
    ...
    jf "빈 아파트에 혼자 있어서 그런지 엄청 해방된 느낌이 들었어, 그래서 청소하고 잠깐 쉬는 동안에..."
...
translate korean d06s03b_993be011:
    ...
    jf "정직하게 말해 줘서 고마워... 으음..."

# game/code/d06/extended/d06s03b.rpy:124
translate korean d06s03b_3f871f46:
...
translate korean d06s03b_8071a97a:
