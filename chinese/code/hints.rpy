translate chinese strings:
    ...
    new "选择此项将显示一个水上运动场景。这也是通往明那里的方法之一。"

    # game/code/hints.rpy:5
    old "You won't get a peeing scene with Stacy."
    new "你和史黛西一起尿尿的场景不会发生的。"
    ...
    new "若你想前往波莉和诺拉那里，则需要选择此项。你会错过明的可选口交场景。但还有另一种方法可以得到明。(最佳选项)"
    ...
    new "若你想前往波莉和诺拉那里，则需要选择此项。不过这样你将错过明的可选口交场景。"
    ...
    new "你想去看看爱洛丝在做什么，但因为门是锁着的，你哪里也去不了。你得帮凯文和克洛伊不被抓到才能拿到钥匙。"

    # game/code/hints.rpy:5
    old "You don't try to go see what AmRose is up to."
    new "你对去看爱洛丝在做什么并不感兴趣。"
    ...
    new "若你不喜欢黛丽娅扮演女王，请选择此项。这也会让你在未来有更多的主导支配性内容。特别是和黛西一起。但你得到的点数会较少。"
    ...
    new "此项使黛西做出顺从的反应--有可能她在以后会更具有顺从性。"
    ...
    new "此选项将继续凯文和克洛伊的道路，并解锁一个有绿帽奴的场景，凯文将看着你和克洛伊享乐。会给更多点数。"
    ...
    new "选择此项你会获得最多的点数。将有一个你和克洛伊肛交的场景，你可以选择在她体内射精或是选择屁股对嘴的姿势。"
    ...
    new "你会警告黛西。最好警告她一下。但如果你不告诉她这次挑战，她会退出来，你就得不到点数。如果你告诉她挑战的事，你会得到8个点数。"

    # game/code/hints.rpy:5
    old "You cum inside Daisy without telling her. You will get 15 points, but she'll be disappointed."
    new "你没告诉黛西就射进她体内。你会得15点数，但她会很失望。"
    ...
    new "你会射进诺拉体内而不告诉她。诺拉会很生气。这将终结通向诺拉和波利的路径，但你会得到15点数。这可能会解锁一个支线故事，即诺拉在未来怀孕。"
    ...
    new "若你转让超过62点数，你将获得一项成就。(总共需要112点数）"
