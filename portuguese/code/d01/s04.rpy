...
translate portuguese replay_d01s04_9c132d58:
    ...
    mct "Alguém simplesmente entrou no banheiro."
...
translate portuguese replay_d01s04_3eef3a8e:
    ...
    mct "Já esta bem tarde. Ninguém deve estar por aqui mais"
...
translate portuguese replay_d01s04_ad5ec6e0:
    ...
    mct "Mas que porra?! Ele sabe que eu acabei de vir pro banheiro. Ai ele trouxe uma garota aqui de proposito?"
...
translate portuguese replay_d01s04_fc3ddb94:
    ...
    cb "Cobre meu peito todo com sua porra!"
...
translate portuguese replay_d01s04_a651910b:
    ...
    mct "Ela quer a foto. Isso é pro desafio do app."
...
translate portuguese replay_d01s04_403dad95:
    ...
    pb "Ela tava faminta por um pouco de porra e ela sabe que sempre que quiser eu vou fornecer."

# game/code/d01/s04.rpy:456
translate portuguese replay_d01s04_2a539ab8:

    # mc "Is it because of that new app?"
    mc "Isso é por conta do app novo?"
...
translate portuguese replay_d01s04_4ed58fa4:
    ...
    pb "Ah, Você já ouviu falar dele né. Sim, Ela precisava desesperadamente de alguns pontos!"
...
translate portuguese replay_d01s04_d1bff6d8:
    ...
    mc "Mas acho que o vencedor de hoje já havia sido escolhido né?!"

# game/code/d01/s04.rpy:462
translate portuguese replay_d01s04_0155661a:

    # pb "I see you already know a lot about Fetish Locator!"
    pb "To vendo que você já sabe bastente sobre o Fetish Locator!"
...
translate portuguese replay_d01s04_361d9674:
    ...
    pb "Sim, você ta certo, o fetiche de hoje já tinha um vencedor. Na verdade já haviam anunciado mais cedo hoje."
...
translate portuguese replay_d01s04_f65bbde0:
    ...
    pb "Mas você sempre pode conseguir alguns pontos fazendo upload de algumas coisas bem quentes pro app. Só tem que estar relacionada ao fetiche do dia."
...
translate portuguese replay_d01s04_c74d9f3c:
    ...
    pb "É sobre isso que eu queria fazer uma proposta pra você"

# game/code/d01/s04.rpy:471
translate portuguese replay_d01s04_81737331:

    # mc "To use the app?"
    mc "Pra eu usar o app?"
...
translate portuguese replay_d01s04_c001942c:
    ...
    pb "Não só isso. Se você abrir o aplicativo tem uma loja com algumas coisas que você pode comprar por pontos."
...
translate portuguese replay_d01s04_d18429d4:
    ...
    pb "Uma das coisas lá é o ingresso pra uma festa. Vai ser daqui dois dias e eu fiquei sabendo que a Lydia vai estar lá."

# game/code/d01/s04.rpy:476
translate portuguese replay_d01s04_9e891473:

    # mc "She's using the app too?!"
    mc "Ela ta usando o app também?!"

# game/code/d01/s04.rpy:478
translate portuguese replay_d01s04_5c557e0e:

    # pb "I'm sure she's probably using it."
    pb "Tenho certeza que ela provavelmente ta usando sim"
...
translate portuguese replay_d01s04_239f55bf:
    ...
    mc "Você tem certeza? Ela não parece ser o tipo de pessoa que usaria."
...
translate portuguese replay_d01s04_552f7159:
    ...
    pb "Eu acho que aqui na escola ta todo mundo usando o app."
...
translate portuguese replay_d01s04_2da0ad6e:
    ...
    mct "Eu provavelmente não deveria contar pro Pete Eu sei quem ganhou esses pontos."
...
translate portuguese replay_d01s04_5410f6a9:
    ...
    pb "Esses são os vencedores do desafio. Eles entregam os pontos uma vez por dia."
...
translate portuguese replay_d01s04_792c5199:
    ...
    pb "Você não tem que vencer o desafio. Você pode só enviar algo interessante e conseguir pontos, só não vão ser tantos quanto se você tivesse ganho o desafio."

# game/code/d01/s04.rpy:497
translate portuguese replay_d01s04_b7b3dc33:

    # mc "Why can't I just buy some points?"
    mc "Por que eu não posso simplesmente comprar alguns pontos?"
...
translate portuguese replay_d01s04_0376ba43:
    ...
    pb "Você pode, mas pra comprar o ingresso pelo menos metade dos pontos você precisa ter ganho e não comprado"
...
translate portuguese replay_d01s04_fb2526d3:
    ...
    mc "Entendi. Nada pode dar errado com esse plano!"
...
translate portuguese replay_d01s04_5b237915:
    ...
    pb "Preciso ir. Tem uma celebração marcada com o time! Té mais!"
...
translate portuguese replay_d01s04_ff2ff749:
    ...
    mct "Esse plano é idiota, Mas o que eu tenho pra perder por tentar?"
...
translate portuguese replay_d01s04_2e86dd70:
    ...
    mct "A festa é daqui dois dias . Não tenho muito tempo pra conseguir esses pontos."
...
translate portuguese replay_d01s04_bdaff425:
    ...
    mct "O fetiche de hoje é Gozada. Até onde ue entendo, eu só preciso postar alguma coisa relacionada a isso."
...
translate portuguese replay_d01s04_18c318ba:
    ...
    mct "Só bater punheta no chuveiro não vai resolver. Acho que precisa ser algo mais.... Impressionante."
