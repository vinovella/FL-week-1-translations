translate french strings:
    ...
    new "Continuer la semaine [FLSS.week.prev]"
    ...
    new "(Définir un nom avant d’enregistrer votre progression)"

    # game/code/screens/screens.rpy:686
    old "Current save name:"
    new "Nom de l’enregistrement actuel:"
    ...
    new "Fait progresser le dialogue et active l’interface."
    ...
    new "Favorise le dialogue sans sélectionner de choix."
    ...
    new "Saute le dialogue tout en le maintenant enfoncé."
    ...
    new "Bascule le saut de dialogue."
    ...
    new "Retour au dialogue précédent."
    ...
    new "Passage au dialogue ultérieur."
    ...
    new "Bascule d’assistance {a=https://www.renpy.org/l/voicing}Voix Auto{/a}."
